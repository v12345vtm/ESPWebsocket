...
String versie = "websocketserverjsonNodemcu12E-v5";
String json = "" ;
...
<h1>thingspeak , usage : http://192.168.1.48/ownthingspeak.html?var=stroomverbruik&val=15</h1>

the server stores the arguments from the url to SD card  eg. : stroomverbruik and 15
<p id="jsonhtml"></p>
...
loadstatus();// haal de json file uit , als die bestaat !!!!
  ...
  server.on("/ownthingspeak.html", []() {
    ...
    //opvangen form argumenten vann input.html

   // Serial.println((server.arg("stm") + "=form argument stm"));
